...
namespace Yumsy_Backend.Persistence.Migrations
{
    ...
    [Migration("20250811182213_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Yumsy_Backend.Persistence.Models.Photo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Yumsy_Backend.Persistence.Models.Photo", b =>
                {
                    b.HasOne("Yumsy_Backend.Persistence.Models.Post", null)
                        .WithMany("Photos")
                        .HasForeignKey("PostId");

                    b.HasOne("Yumsy_Backend.Persistence.Models.Step", "Step")
                        .WithOne("Photo")
                        .HasForeignKey("Yumsy_Backend.Persistence.Models.Photo", "StepId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
