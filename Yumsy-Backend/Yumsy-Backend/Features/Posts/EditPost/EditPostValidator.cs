...
public class EditPostRequestBodyValidator : AbstractValidator<EditPostRequestBody>
{
    ...
    private bool HaveSequentialSteps(IEnumerable<EditPostRequestRecipeStepBody> steps)
    {
...
public class AddPostTagValidator : AbstractValidator<AddPostRequestTagBody>
{
...
public class AddPostImageValidator : AbstractValidator<EditPostRequestImageBody>
{
...
public class AddPostIngredientValidator : AbstractValidator<EditPostRequestIngredientBody>
{
...
public class AddPostRecipeStepValidator : AbstractValidator<EditPostRequestRecipeStepBody>
{
